								...
								<article class="cf wrap post-410 team type-team status-publish has-post-thumbnail hentry profile-category-manager" role="article">
									...
									<section class="entry-content cf wow fadeInUp">
										<div class="m-all t-1of3 d-1of3 about-the-quickfacts">
											<table>
												<tr><td><img src="image/Stacey.jpg" border="0"></td><td></td></tr>												
											</table>																						
										</div>
										<div class="m-all t-2of3 d-2of3 pad about-the-course">
											<p class="p1">Stacey brings over six years of credential program management and operations experience to AERE. As the manager of test development at the Green Building Certification Institute, Stacey worked on a variety of certification programs, including an internationally recognized credential with over 100,000 certificants (the LEED AP), three certificate programs (the LEED for Homes Green Rater, LEED Project Reviewer, and Green Classroom Professional), and a portfolio assessment program (the LEED Fellow). She has experience with recruitment and retention of subject matter experts, item writing, item review, exam reviews, standard setting, test delivery, and job analyses.</p>

<p class="p1">Stacey also has extensive project management and operations experience. She has managed a variety of projects including translations, data migrations, exam development cycles, technology implementations, and the acquisition and integration of new programs. She loves spreadsheets, calendars, and checklists, and knows how to keep the technical folks organized and on track. While in an operations role at the U.S. Green Building Council, she also managed GBCI’s ANSI/ISO/IEC 17024 accreditation, including the documentation and management of the annual surveillance process, oversight of the management system, internal auditing of the accreditation, and responses to non-conformities.



</p>

<p class="p1"><strong>- Stacey McLaughlin – Senior Manager of Operations </strong></p>
										</div>										
									</section>
