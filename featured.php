								...
								<article class="cf wrap post-410 team type-team status-publish has-post-thumbnail hentry profile-category-manager" role="article">
									...
									<section class="entry-content cf">
										<div class="m-all t-all d-all">
											<h5 class="push-color text-left"><a href='upcoming.php'>Upcoming</a> | <a class="active"  href='featured.php'>Fetured</a> | <a href='finished.php'>Completed</a></h5>
											<table width="100%" border='1'>
											<tr><th>Course Title</th><th>Start Date</th><th>End Date</th><th>Location</th><th>Time</th><th>Fees</th><th>&nbsp;</th></tr> 
											<?php
												
												$date=date('Y-m-d');
												$cnd="  StartDate > '$date'  ";
												$res=mysql_query("SELECT * FROM tblcourse Where 1=1 and $cnd order by StartDate");
												...
												echo "<td class='text-center'>".$data['Location']."</td>";
												 
												echo "<td class='text-center'>".$data['Time']."</td>";
												$CourseFees = (is_numeric($data['CourseFees'])?"$".$data['CourseFees']:$data['CourseFees']);
												echo "<td class='text-center'>".$CourseFees."</td>";
												 
												echo "<td class='text-center'><a href='registration.php?cid=".$data['CourseID']."'>View</a></td>";
