    ...
    <div id="inner-content" class="cf">
        ...
        <div class="section-white section-one services_page">
            ...
            <article class="cf m-all t-2of3 d-2of3 post-322 course type-course status-publish has-post-thumbnail hentry course-category-management course-tag-feature" role="article">
                    <header class="article-header">
                <h1 class="wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;"> Assessment Services </h1>
              </header>
                    <section class="entry-content text-left cf wow fadeInUp" data-wow-delay="0.5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInUp;"> 
                ...
                <div class="pad about-the-course">
                        <h5 class="push-color text-left">Test Development</h5>
                        <p>AERE provides consulting services for every step in the test design and development lifecycle process, including but not limited to job analysis, test specifications/blueprint/content outline, item writing including alternative item types/innovative item types, item editing, item review, and test design and assembly.</p>
                        
                        <h5 class="push-color text-left">Psychometric Services</h5>
                        <p>AERE provides psychometric services which includes item analysis using both classical and item response theory (IRT) models, equating, scaling, differential item functioning (DIF), fit analyses, reliability analyses, and standard setting studies.</p>
                        
                        <h5 class="push-color text-left">Performance Assessments</h5>
                       
						<p>AERE provides consulting services in the development of performance assessments including but not limited to identifying and developing the test content (e.g.,  low to high fidelity animated scenarios, simulated computing and internet conditions, standardized performers and live simulations, on-the-job performance observations),  developing rubrics (e.g., analytic, holistic), training and calibration of raters, scoring and feedback, and interrater reliability.</p>
                        
                        <h5 class="push-color text-left">Accreditation Consultation</h5>
                        <p>AERE provides accreditation consulting services for organizations seeking or maintaining certification and certificate programs under the ANSI (17024/ASTM E2659) or NCCA standards.</p>
                        
                        <h5 class="push-color text-left">Employment Selection Assessments</h5>
                        <p>AERE develops employment selection assessments to meet the Uniform Guidelines.</p>
                        
                        <h5 class="push-color text-left">Neurocompetency</h5>
