	  ...
	  <div class="section-white section-one">
								<article class="cf wrap post-410 team type-team status-publish has-post-thumbnail hentry profile-category-manager" role="article">
									...
									<header class="article-header wow fadeInUp">
										...
										<h1 class="page-title">Liberty J. Munson, Ph.D.</h1>
									...
									<section class="entry-content cf wow fadeInUp">
										<div class="m-all t-1of3 d-1of3 about-the-quickfacts">
											<table>
												<tr><td><img src="image/Liberty.jpg" border="0"></td><td></td></tr>												
											</table>																						
										</div>
										<div class="m-all t-2of3 d-2of3 pad about-the-course">
											<p class="p1">Liberty Munson, PhD, is the Principal Psychometrician and Product Quality Lead for Microsoft Learning’s technical certification program. She is responsible for ensuring that psychometric standards are rigorously applied during all phases of the certification exam lifecycle and that the design and implementation of Microsoft’s Certification program results in valid and reliable assessments of candidate skills.</p>
                                            <p class="p1">Liberty works closely with her team to design, develop, and evaluate innovative item types, design new delivery and development methodologies, implement strategic processes to proactively address piracy issues, and ensure the quality of the exam content from a psychometric and candidate perspective. </p>
                                            <p class="p1">Prior to joining Microsoft, Liberty worked at Boeing where she developed a wide variety of selection tests, including multiple-choice exams, team-based exercises, problem solving activities, and structured interviews; she also assisted with the development and analysis of Boeing’s internal certification exams and acted as a co-project manager overseeing development, administration, and analysis of Boeing’s Employee Survey. </p>
                                            <p class="p1">Liberty received her BS in Psychology from Iowa State University and her MA and PhD in Industrial/Organizational Psychology with minors in Quantitative Psychology and Human Resource Management from the University of Illinois at Urbana-Champaign. </p>


<p class="p1"><strong>- Liberty – Chief Psychometrics, Assessment, and Research Officer </strong></p>
										</div>										
									</section>
							...
							<div  class="section-white wrap pad  page-template-page-ourstory">
                                ...
                                <article class="cf m-all t-1of6 d-1of4 post-439 team type-team status-publish has-post-thumbnail hentry profile-category-manager wow fadeInUp glwidth" role="article">
                                    <a class="course-button scrolled manager" href="Jennifer.html">
                                        <div class="article-image">
                                            <div class="article-hover push-bg-color">
                                                <h4>VIEW PROFILE</h4>
                                            </div>
