	  ...
	  <div class="section-white section-one">
								<article class="cf wrap post-410 team type-team status-publish has-post-thumbnail hentry profile-category-manager" role="article">
									...
									<header class="article-header wow fadeInUp">
										<h1 class="page-title">Conformation Otp</h1>
									</header>
					...
					<input type="hidden" name="action" value="signUp" />
						...
						<div class="form-group">
							<label class="sr-only" for="firstname">Password</label>
																<br>
							<input maxlength="50" name="otp" placeholder="Enter your code" class="firstname form-control"  type="text" required data-parsley-pattern="^[0-9]+$">
						</div>
						...
						{?>
							...
							<?php 
							       ...
							       require_once('email/class.phpmailer.php');
									...
									$mail->Body = "<img src='http://aerexperts.com/image/logo.png' height='80px' width='180px'> 
									<br><br><br>
									Hello, <br/>
