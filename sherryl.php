								...
								<article class="cf wrap post-410 team type-team status-publish has-post-thumbnail hentry profile-category-manager" role="article">
									...
									<section class="entry-content cf wow fadeInUp">
										<div class="m-all t-1of3 d-1of3 about-the-quickfacts">
											<table>
												<tr><td><img src="image/sherryl.jpg" border="0"></td><td></td></tr>												
											</table>																						
										</div>
										<div class="m-all t-2of3 d-2of3 pad about-the-course">
											<p class="p1">Sherryl is responsible for understanding the firms’ initiatives and goals within their assessment, education, and licensure/certification and research domains. She facilitates effective and unparalleled relationships with her clients and our partners. With over eight years of distinguished sales experience with an emphasis on customer retention and corporate account acquisition, Sherryl brings genuine and personable client service.</p>
                                            <p class="p1">Before joining AERE, she held a role as Research Associate for International Credentialing Associates, 2014-2015, supporting and independently completing technical research, review, training, product development, branding, psychometric, and marketing functions while co-facilitating client workshops. She has attended industry conferences, including The Association of Test Publishers (ATP) in 2014 and 2015.</p>
											<p class="p1">In addition, she currently works as a Clinical Research Coordinator for Towson University’s Department of Psychology. She is currently working on the Family Training for Hoarding Study to provide treatment and family training for hoarders.</p>
                                            <p class="p1">Sherryl holds a Bachelors of Arts degree in Psychology from the University of Maryland, Baltimore County with a minor in Judaic Studies.</p>

<p class="p1"><strong>- Sherryl Hering – Manager of Business Development and Research Services </strong></p>
										</div>										
									</section>
