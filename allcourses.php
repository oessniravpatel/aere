...
<div id="container">
	  ...
	  <div class="section-white section-one">
								<article class="cf wrap post-410 team type-team status-publish has-post-thumbnail hentry profile-category-manager" role="article">
									...
									<header class="article-header wow fadeInUp">
										<h1 class="page-title">All Institute</h1>
									</header>
	...
	<!-- NEW CODE HERE  -->								
        ...
        <div class="inner-page-banner-area" style="background-image: url('image/image1.jpg');">
		 ...
		 <div class="article-content m-all t-2of5">

                        <div class="byline vcard ">&nbsp; </div>
                        <div class="paragraph-content" style="margin:0 90 0 110; margin-top:0px !important;">
                            <p>Welcome to the <span style="color: #c00808">Applied Lifelong Learning Institute (ALL-Institute)</span>. Our philosophy is very simple, we will provide a learning opportunity that is engaging, meaningful, and aligned to real-world work situations across the career lifespan. Our chief complaint with employers who we develop learning and assessment solutions is that their current solutions don't resemble the real world. So, like our eLearning, training, and assessment solutions, the ALL-Institute develops a curriculum and learning experience that is applied, real-world, problem-based, and represents the needs of the employers and ultimately helps the learner succeed.
                            </p>
