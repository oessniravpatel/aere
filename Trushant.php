	  ...
	  <div class="section-white section-one">
								<article class="cf wrap post-410 team type-team status-publish has-post-thumbnail hentry profile-category-manager" role="article">
									...
									<header class="article-header wow fadeInUp">
										...
										<h1 class="page-title">Trushant Mehta</h1>
									...
									<section class="entry-content cf wow fadeInUp">
										<div class="m-all t-1of3 d-1of3 about-the-quickfacts">
											<table>
												<tr><td><img src="image/Trushant.png" border="0"></td><td></td></tr>												
											</table>																						
										</div>
										<div class="m-all t-2of3 d-2of3 pad about-the-course">
											<p class="p1">Trushant has more than 17 years of experience assuring the successful execution of the many client's business mission through development and deployment of the their web presence. Identifying opportunities and risks for delivering the client's services as a web-based business, including identification of competitive services, opportunities for innovation, and assessment of marketplace obstacles and technical hurdles to the business success are few of the key responsibilities Trushant have served.</p>
										    <p class="p1">With Masters degree in Computer Applications, Trushant have corss-domain expertise working with Federal Government like U. S. Department of Health and Human Services, State Government agencies like D. C. Department of Employment Services, Non-profit membership organizations like U. S. Green Building Council, International organizations like United Nations at their European HQ in Switzerland, profitable organizations like Ryan Homes and many more under his belt. He is also proud co-founder of a startup company - OpenEyes Technologies Inc. focusing on data integrity and custom software solutions.</p>
                                            <p class="p1">In his spare time, Trushant is serving as a volunteer board member for his Homeowner Associations since 2007 and follows TED (& TEDx) talks crazily.</p>

<p class="p1"><strong>- Trushant – Chief Technology Officer </strong></p>
										</div>										
									</section>
