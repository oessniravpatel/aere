...
Please click on the link below to complete and activate your account with us.</p>
			...
			if (!smtpmailer($email, ADMIN_EMAIL, ADMIN_NAME, $subject, $message)) {
				...
				echo $msg = "
					...
					Your registration detail have been received. Please check your email to confirm and activate your account with AERE. Come back to register for offered courses
			  		</div>
					";
			}
