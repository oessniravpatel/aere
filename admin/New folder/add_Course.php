...
if (isset($_POST['save'])) {
    ...
    $IsStatus = trim($_POST['IsStatus']);
    $IsStatus = strip_tags($IsStatus);
    $IsStatus = htmlspecialchars($IsStatus);
    ...
    if (!$error) {
        ...
        $query = "INSERT INTO `tblcourse`(Title,OfferedBy,Summary,StartDate,EndDate,Location,Time,IntendedAudience,MeetingType,CourseFees,TotalCapacity,NoofUserRegistered,Instructor,Instigator,IsStatus,CreatedBy,CreatedOn,ModifiedBy,ModifiedOn) VALUES('$Title','$OfferedBy','$Summary','$StartDate','$EndDate','$Location','$Time','$IntendedAudience','$MeetingType','$CourseFees','$TotalCapacity','$NoofUserRegistered','$Instructor','$Instigator','1','$CreatedBy',now(),'$ModifiedBy',now())";
                ...
                <form name="form_register" id='form_register' method="post" class="my_frm"  enctype="multipart/form-data" >
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="StartDate" id="StartDate"  class="form-control" placeholder=" Start Date "/></td>
                        </tr>
                        <tr>
                            <th>* End Date : </th>
                            ...
                            <td><input type="text" name="EndDate" id="EndDate"  class="form-control" placeholder=" End Date "/></td>
                        </tr>
                        <tr>
                            <th> * Location :</th>

                            <td><input type="text" name="Location" id="Location" class="form-control" placeholder="Location"/></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="Time" id="Time"  class="form-control" placeholder="Time"/></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="Instigator" id="Instigator"  class="form-control" placeholder="Instigator"/></td>
                        </tr>

                        <tr>
                            <th>* Created By :</th>

                            <td><input type="text" name="CreatedBy" id="CreatedBy"  class="form-control" placeholder="Created By"/></td>
                        </tr>
                 ...
                 'IntendedAudience': {
                    ...
                    messages: {
                        ...
                        'OfferedBy': {
                            ...
                            required: "The Offered By field is mandatory!",
                        ...
                        'StartDate': {
                            ...
                            required: "The start date By field is mandatory!",
                        ...
                        'EndDate': {
                            ...
                            required: "The end date By field is mandatory!",
                        ...
                        'Location': {
                            ...
                            required: "The location By field is mandatory!",
                        ...
                        'Time': {
                            ...
                            required: "The Time By field is mandatory!",
                        ...
                        'IntendedAudience': {
                            ...
                            required: "The intendedAudience By field is mandatory!",
                        ...
                        'MeetingType': {
                            ...
                            required: "The meetingType By field is mandatory!",
                        ...
                        'CourseFees': {
                            ...
                            required: "The course fees By field is mandatory!",
                        ...
                        'TotalCapacity': {
                            ...
                            required: "The total capacity By field is mandatory!",
                        ...
                        'NoofUserRegistered': {
                            ...
                            required: "The no of user registered By field is mandatory!",

                        },
                        
                        'Instructor': {

                            required: "The instructor By field is mandatory!",

                        },
                
                'Instigator': {

                            required: "The instigator By field is mandatory!",
